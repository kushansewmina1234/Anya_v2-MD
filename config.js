...
global.botname = process.env.BotName || "DARK SHAN" 
global.author = process.env.Author || "@KUSHN" 
global.packname = process.env.PackName || "DARK SHAN MD" 
global.myweb = process.env.Web || "https://github.com/PikaBotz" 
global.footer = process.env.Footer || "© DARK SHAN BOT" 
global.prefa = process.env.Prefix || ['.'] 
global.themeemoji = process.env.ThemeEmoji || "🎐" 
global.ownername = process.env.Owner_Name || "KUSHAN" 
global.ownernumber = process.env.Owner_Number || "94725668277" 
global.adress = process.env.Continent || "Asia, sri lanka, mathara" 
...
module.exports = {
  botname: process.env.BotName || "DARK SHAN, 
  author: process.env.Author || "@KUSHAN",
  packname: process.env.PackName || "DARK SHAN MD",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© DARK SHAN BOT",
  prefa: process.env.Prefix || ['.'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "KUSHAN",
  ownernumber: process.env.Owner_Number || "94725668277",
  adress: process.env.Continent || "Asia, sri lanka, mathara",
  ...
  sessionId: process.env.SESSION_ID || "bUxYZjd_Queen-Anya_1UjU=", 
